...
namespace MyStuffAPI.Attributes
{
    [AttributeUsage(validOn: AttributeTargets.All)]
    public sealed class ApiKeyAttribute : Attribute, IAsyncActionFilter
    {
        //aca creamos un atributo que luego usaremos como decoración en los controllers
        //para agregar una capa de seguriad a la hora de consumir el recurso (ruta) 
